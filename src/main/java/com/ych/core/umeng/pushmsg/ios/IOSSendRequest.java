...
public class IOSSendRequest {
	 ...
	 * 必填,消息内容(iOS最大为2012B)
	 */
	private IOSSendRequestPayload payload;
	...
	/**
	 * @return 必填,消息内容(iOS最大为2012B)
	 */
	public IOSSendRequestPayload getPayload() {
		return payload;
	}
	 ...
	 *            必填,消息内容(iOS最大为2012B)
	 */
	public void setPayload(IOSSendRequestPayload payload) {
